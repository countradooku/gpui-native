...
use gpui::{
    App, Axis, Div, Hsla, IntoElement, ParentElement, PathBuilder, RenderOnce, StyleRefinement,
...
impl Separator {
    ...
    pub fn label(mut self, label: impl Into<crate::text::Text>) -> Self {
