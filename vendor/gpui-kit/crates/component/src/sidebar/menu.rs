...
pub struct SidebarMenuItem {
    icon: Option<Icon>,
    label: SharedString,
    label_content: Option<crate::text::Text>,
...
impl SidebarMenuItem {
    ...
    /// Supply custom text presentation while retaining the accessible label.
    pub fn label_content(mut self, content: crate::text::Text) -> Self {
        self.label_content = Some(content);
        self
    }
                                    ...
                                    .child(
                                        h_flex()
                                            ...
                                            .child(
                                                self.label_content
                                                    .clone()
                                                    .unwrap_or_else(|| self.label.clone().into()),
                                            ),
                                    )
