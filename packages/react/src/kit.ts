import { KIT_COMPONENTS, kitHostProps, type KitComponentProps } from "@gpui-native/runtime/kit"
import { createElement, type ComponentType, type ReactNode } from "react"
export type * from "@gpui-native/runtime/kit"

function component<K extends keyof KitComponentProps>(
  name: K,
): ComponentType<KitComponentProps[K] & { children?: ReactNode }> {
  return (props) =>
    createElement(KIT_COMPONENTS[name], kitHostProps(props as Record<string, unknown>))
}
