...
pub use paint::{
    HighlightSource, PaintedHighlight, SelectableText, SharedSelection, chrome_text,
    log_painted_text, painted_highlights, painted_text, range_rects, record_start_region,
    selectable_text, selection_frame_reset, selection_key,
};
