//! Persistent GPUI list state and Vue window synchronization.

#![allow(
    clippy::cast_possible_truncation,
    clippy::cast_sign_loss,
    reason = "validated JavaScript list indices and metrics narrow to native list types"
)]
...
pub(super) fn window_start_from_element(element: &crate::retained_tree::RetainedElement) -> usize {
    element
        .custom_props
        .get("windowStart")
        .and_then(json_usize)
...
impl VirtualListConfig {
    pub(super) fn from_element(element: &crate::retained_tree::RetainedElement) -> Self {
...
impl VirtualListEntry {
    ...
    #[allow(
        ...
        reason = "virtual-list cache synchronization is one ordered retained-state transaction"
    )]
    pub(super) fn sync(
        &mut self,
        config: VirtualListConfig,
